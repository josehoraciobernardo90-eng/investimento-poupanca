    ...
    <div className="space-y-6">
      <div className="flex items-center gap-4">
        ...
        {!isLiquidado && !s.deveBloqueiar && (
          <button 
            onClick={() => {
              setValorPago((s.totalDevido / 100).toFixed(2));
          ...
          >
            ...
            <form onSubmit={handleLiquidate} className="space-y-4">
              ...
              <div className="bg-warning/10 border border-warning/20 p-4 rounded-xl mt-4">
                <p className="text-xs text-warning mb-1">Valor calculado pelo sistema (base + juro {s.taxaAtual}%):</p>
                <p className="text-lg font-bold font-mono text-white">{formatMT(s.totalDevido)}</p>
              </div>
